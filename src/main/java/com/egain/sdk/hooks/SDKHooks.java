...
public final class SDKHooks {
    ...
    public static void initialize(com.egain.sdk.utils.Hooks hooks) {
    ...
    public static void initialize(com.egain.sdk.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(com.egain.sdk.utils.HookAdapters.adapt(mySyncHook));
