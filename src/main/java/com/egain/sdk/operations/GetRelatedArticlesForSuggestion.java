...
public class GetRelatedArticlesForSuggestion {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRelatedArticlesForSuggestionRequest, GetRelatedArticlesForSuggestionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRelatedArticlesForSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedArticlesForSuggestionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRelatedArticlesForSuggestionRequest request) {
        ...
        @Override
        public GetRelatedArticlesForSuggestionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRelatedArticlesForSuggestionResponse.Builder resBuilder =
                    GetRelatedArticlesForSuggestionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetRelatedArticlesForSuggestionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFeedbackArticleForSuggestion(Utils.unmarshal(response, new TypeReference<FeedbackArticleForSuggestion>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRelatedArticlesForSuggestionRequest, com.egain.sdk.models.operations.async.GetRelatedArticlesForSuggestionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRelatedArticlesForSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedArticlesForSuggestionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRelatedArticlesForSuggestionRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetRelatedArticlesForSuggestionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetRelatedArticlesForSuggestionResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetRelatedArticlesForSuggestionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetRelatedArticlesForSuggestionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FeedbackArticleForSuggestion>() {})
                            .thenApply(res::withFeedbackArticleForSuggestion);
                } else {
