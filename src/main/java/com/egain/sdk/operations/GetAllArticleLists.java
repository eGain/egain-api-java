...
import com.egain.sdk.models.components.ArticleListsResult;
...
public class GetAllArticleLists {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllArticleListsRequest, GetAllArticleListsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllArticleListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllArticleListsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllArticleListsRequest request) {
        ...
        @Override
        public GetAllArticleListsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllArticleListsResponse.Builder resBuilder =
                    GetAllArticleListsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAllArticleListsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticleListsResult(Utils.unmarshal(response, new TypeReference<ArticleListsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllArticleListsRequest, com.egain.sdk.models.operations.async.GetAllArticleListsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllArticleListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllArticleListsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllArticleListsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllArticleListsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllArticleListsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllArticleListsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllArticleListsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ArticleListsResult>() {})
                            .thenApply(res::withArticleListsResult);
                } else {
