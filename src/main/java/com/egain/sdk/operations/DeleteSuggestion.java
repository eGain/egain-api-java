...
public class DeleteSuggestion {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSuggestionRequest, DeleteSuggestionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSuggestionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSuggestionRequest request) {
        ...
        @Override
        public DeleteSuggestionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSuggestionResponse.Builder resBuilder =
            ...
            DeleteSuggestionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSuggestionRequest, com.egain.sdk.models.operations.async.DeleteSuggestionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSuggestionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSuggestionRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.DeleteSuggestionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.DeleteSuggestionResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.DeleteSuggestionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.DeleteSuggestionResponse res = resBuilder.build();
