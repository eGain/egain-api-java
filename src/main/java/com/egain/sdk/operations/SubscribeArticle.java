...
public class SubscribeArticle {
    ...
    public static class Sync extends Base
            implements RequestOperation<SubscribeArticleRequest, SubscribeArticleResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SubscribeArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SubscribeArticleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SubscribeArticleRequest request) {
        ...
        @Override
        public SubscribeArticleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SubscribeArticleResponse.Builder resBuilder =
            ...
            SubscribeArticleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribeArticleRequest, com.egain.sdk.models.operations.async.SubscribeArticleResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(SubscribeArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SubscribeArticleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SubscribeArticleRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.SubscribeArticleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.SubscribeArticleResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.SubscribeArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.SubscribeArticleResponse res = resBuilder.build();
