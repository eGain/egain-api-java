...
import com.egain.sdk.models.components.CasebaseResult;
...
public class GetAllCasebasesReleases {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllCasebasesReleasesRequest, GetAllCasebasesReleasesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllCasebasesReleasesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllCasebasesReleasesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllCasebasesReleasesRequest request) {
        ...
        @Override
        public GetAllCasebasesReleasesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllCasebasesReleasesResponse.Builder resBuilder =
                    GetAllCasebasesReleasesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAllCasebasesReleasesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCasebaseResult(Utils.unmarshal(response, new TypeReference<CasebaseResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllCasebasesReleasesRequest, com.egain.sdk.models.operations.async.GetAllCasebasesReleasesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllCasebasesReleasesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllCasebasesReleasesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllCasebasesReleasesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllCasebasesReleasesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllCasebasesReleasesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllCasebasesReleasesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllCasebasesReleasesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CasebaseResult>() {})
                            .thenApply(res::withCasebaseResult);
                } else {
