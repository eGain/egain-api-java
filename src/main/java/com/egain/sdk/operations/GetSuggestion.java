...
public class GetSuggestion {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSuggestionRequest, GetSuggestionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSuggestionRequest request) {
        ...
        @Override
        public GetSuggestionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSuggestionResponse.Builder resBuilder =
            ...
            GetSuggestionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSuggestion(Utils.unmarshal(response, new TypeReference<Suggestion>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSuggestionRequest, com.egain.sdk.models.operations.async.GetSuggestionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSuggestionRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetSuggestionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetSuggestionResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetSuggestionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetSuggestionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Suggestion>() {})
                            .thenApply(res::withSuggestion);
                } else {
