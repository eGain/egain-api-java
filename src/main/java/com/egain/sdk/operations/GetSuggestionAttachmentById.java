...
public class GetSuggestionAttachmentById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSuggestionAttachmentByIdRequest, GetSuggestionAttachmentByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSuggestionAttachmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionAttachmentByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSuggestionAttachmentByIdRequest request) {
        ...
        @Override
        public GetSuggestionAttachmentByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSuggestionAttachmentByIdResponse.Builder resBuilder =
                    GetSuggestionAttachmentByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetSuggestionAttachmentByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSuggestionAttachment(Utils.unmarshal(response, new TypeReference<SuggestionAttachment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSuggestionAttachmentByIdRequest, com.egain.sdk.models.operations.async.GetSuggestionAttachmentByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSuggestionAttachmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionAttachmentByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSuggestionAttachmentByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetSuggestionAttachmentByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetSuggestionAttachmentByIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetSuggestionAttachmentByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetSuggestionAttachmentByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SuggestionAttachment>() {})
                            .thenApply(res::withSuggestionAttachment);
                } else {
