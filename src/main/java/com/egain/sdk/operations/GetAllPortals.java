...
public class GetAllPortals {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllPortalsRequest, GetAllPortalsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllPortalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllPortalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllPortalsRequest request) {
        ...
        @Override
        public GetAllPortalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllPortalsResponse.Builder resBuilder =
            ...
            GetAllPortalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPortalResult(Utils.unmarshal(response, new TypeReference<PortalResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllPortalsRequest, com.egain.sdk.models.operations.async.GetAllPortalsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllPortalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllPortalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllPortalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllPortalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllPortalsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllPortalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllPortalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PortalResult>() {})
                            .thenApply(res::withPortalResult);
                } else {
