...
public class CreateQuickpick {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateQuickpickRequest, CreateQuickpickResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateQuickpickRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateQuickpickRequest.class, new TypeReference<CreateQuickpickRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateQuickpickRequest request) {
        ...
        @Override
        public CreateQuickpickResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateQuickpickResponse.Builder resBuilder =
                    CreateQuickpickResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateQuickpickResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateQuickpickRequest, com.egain.sdk.models.operations.async.CreateQuickpickResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateQuickpickRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateQuickpickRequest.class, new TypeReference<CreateQuickpickRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateQuickpickRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.CreateQuickpickResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.CreateQuickpickResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.CreateQuickpickResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.CreateQuickpickResponse res = resBuilder.build();
