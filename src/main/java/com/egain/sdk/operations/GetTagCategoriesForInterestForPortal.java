...
public class GetTagCategoriesForInterestForPortal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTagCategoriesForInterestForPortalRequest, GetTagCategoriesForInterestForPortalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTagCategoriesForInterestForPortalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTagCategoriesForInterestForPortalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTagCategoriesForInterestForPortalRequest request) {
        ...
        @Override
        public GetTagCategoriesForInterestForPortalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTagCategoriesForInterestForPortalResponse.Builder resBuilder =
                    GetTagCategoriesForInterestForPortalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetTagCategoriesForInterestForPortalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTagCategoriesForInterest(Utils.unmarshal(response, new TypeReference<TagCategoriesForInterest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTagCategoriesForInterestForPortalRequest, com.egain.sdk.models.operations.async.GetTagCategoriesForInterestForPortalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTagCategoriesForInterestForPortalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTagCategoriesForInterestForPortalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTagCategoriesForInterestForPortalRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetTagCategoriesForInterestForPortalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetTagCategoriesForInterestForPortalResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetTagCategoriesForInterestForPortalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetTagCategoriesForInterestForPortalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TagCategoriesForInterest>() {})
                            .thenApply(res::withTagCategoriesForInterest);
                } else {
