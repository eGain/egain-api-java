...
public class GetArticlesInTopic {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticlesInTopicRequest, GetArticlesInTopicResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticlesInTopicRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticlesInTopicRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticlesInTopicRequest request) {
        ...
        @Override
        public GetArticlesInTopicResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticlesInTopicResponse.Builder resBuilder =
                    GetArticlesInTopicResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetArticlesInTopicResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticlesInTopicRequest, com.egain.sdk.models.operations.async.GetArticlesInTopicResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticlesInTopicRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticlesInTopicRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticlesInTopicRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticlesInTopicResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticlesInTopicResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticlesInTopicResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticlesInTopicResponse res = resBuilder.build();
