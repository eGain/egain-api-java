...
public class AiSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<AiSearchRequest, AiSearchResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AiSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AiSearchRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AiSearchRequest request) {
        ...
        @Override
        public AiSearchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AiSearchResponse.Builder resBuilder =
                    AiSearchResponse
                            .builder()
            ...
            AiSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAISearchResponse(Utils.unmarshal(response, new TypeReference<AISearchResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AiSearchRequest, com.egain.sdk.models.operations.async.AiSearchResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AiSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AiSearchRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AiSearchRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.AiSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.AiSearchResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.AiSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.AiSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AISearchResponse>() {})
                            .thenApply(res::withAISearchResponse);
                } else {
