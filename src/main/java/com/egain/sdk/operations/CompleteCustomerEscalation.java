...
public class CompleteCustomerEscalation {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/portals/{portalID}/escalate/{escalationId}/complete",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<CompleteCustomerEscalationRequest, CompleteCustomerEscalationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CompleteCustomerEscalationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CompleteCustomerEscalationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CompleteCustomerEscalationRequest request) {
        ...
        @Override
        public CompleteCustomerEscalationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CompleteCustomerEscalationResponse.Builder resBuilder =
                    CompleteCustomerEscalationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CompleteCustomerEscalationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CompleteCustomerEscalationRequest, com.egain.sdk.models.operations.async.CompleteCustomerEscalationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CompleteCustomerEscalationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CompleteCustomerEscalationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CompleteCustomerEscalationRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.CompleteCustomerEscalationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.CompleteCustomerEscalationResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.CompleteCustomerEscalationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.CompleteCustomerEscalationResponse res = resBuilder.build();
