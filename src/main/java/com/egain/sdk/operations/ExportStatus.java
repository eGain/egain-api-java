...
public class ExportStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<ExportStatusRequest, ExportStatusResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ExportStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ExportStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ExportStatusRequest request) {
        ...
        @Override
        public ExportStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ExportStatusResponse.Builder resBuilder =
            ...
            ExportStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExportStatus(Utils.unmarshal(response, new TypeReference<com.egain.sdk.models.components.ExportStatus>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ExportStatusRequest, com.egain.sdk.models.operations.async.ExportStatusResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ExportStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ExportStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ExportStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.ExportStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.ExportStatusResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.ExportStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.ExportStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.egain.sdk.models.components.ExportStatus>() {})
                            .thenApply(res::withExportStatus);
                } else {
