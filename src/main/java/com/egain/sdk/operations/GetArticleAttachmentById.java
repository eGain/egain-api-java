...
public class GetArticleAttachmentById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticleAttachmentByIdRequest, GetArticleAttachmentByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticleAttachmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleAttachmentByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticleAttachmentByIdRequest request) {
        ...
        @Override
        public GetArticleAttachmentByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticleAttachmentByIdResponse.Builder resBuilder =
                    GetArticleAttachmentByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetArticleAttachmentByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticleAttachmentByIdRequest, com.egain.sdk.models.operations.async.GetArticleAttachmentByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticleAttachmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleAttachmentByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticleAttachmentByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticleAttachmentByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticleAttachmentByIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticleAttachmentByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticleAttachmentByIdResponse res = resBuilder.build();
