...
public class GetAllQuickPicks {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllQuickPicksRequest, GetAllQuickPicksResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllQuickPicksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllQuickPicksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllQuickPicksRequest request) {
        ...
        @Override
        public GetAllQuickPicksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllQuickPicksResponse.Builder resBuilder =
            ...
            GetAllQuickPicksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQuickpickResults(Utils.unmarshal(response, new TypeReference<QuickpickResults>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllQuickPicksRequest, com.egain.sdk.models.operations.async.GetAllQuickPicksResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllQuickPicksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllQuickPicksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllQuickPicksRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllQuickPicksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllQuickPicksResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllQuickPicksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllQuickPicksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<QuickpickResults>() {})
                            .thenApply(res::withQuickpickResults);
                } else {
