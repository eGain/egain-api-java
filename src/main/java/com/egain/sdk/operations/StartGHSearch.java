...
public class StartGHSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartGHSearchRequest, StartGHSearchResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(StartGHSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartGHSearchRequest.class, new TypeReference<StartGHSearchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartGHSearchRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "406", "415", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public StartGHSearchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartGHSearchResponse.Builder resBuilder =
            ...
            StartGHSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGHSearchResult(Utils.unmarshal(response, new TypeReference<GHSearchResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartGHSearchRequest, com.egain.sdk.models.operations.async.StartGHSearchResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StartGHSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartGHSearchRequest.class, new TypeReference<StartGHSearchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartGHSearchRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "403", "404", "406", "415", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.StartGHSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.StartGHSearchResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.StartGHSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.StartGHSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GHSearchResult>() {})
                            .thenApply(res::withGHSearchResult);
                } else {
