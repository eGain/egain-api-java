...
public class GetAllUserProfiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllUserProfilesRequest, GetAllUserProfilesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllUserProfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllUserProfilesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllUserProfilesRequest request) {
        ...
        @Override
        public GetAllUserProfilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllUserProfilesResponse.Builder resBuilder =
            ...
            GetAllUserProfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUserProfiles(Utils.unmarshal(response, new TypeReference<UserProfiles>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllUserProfilesRequest, com.egain.sdk.models.operations.async.GetAllUserProfilesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllUserProfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllUserProfilesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllUserProfilesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllUserProfilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllUserProfilesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllUserProfilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllUserProfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UserProfiles>() {})
                            .thenApply(res::withUserProfiles);
                } else {
