...
public class AcceptGHSolution {
    ...
    public static class Sync extends Base
            implements RequestOperation<AcceptGHSolutionRequest, AcceptGHSolutionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AcceptGHSolutionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AcceptGHSolutionRequest.class, new TypeReference<AcceptGHSolutionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AcceptGHSolutionRequest request) {
        ...
        @Override
        public AcceptGHSolutionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AcceptGHSolutionResponse.Builder resBuilder =
                    AcceptGHSolutionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AcceptGHSolutionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AcceptGHSolutionRequest, com.egain.sdk.models.operations.async.AcceptGHSolutionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AcceptGHSolutionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AcceptGHSolutionRequest.class, new TypeReference<AcceptGHSolutionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AcceptGHSolutionRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.AcceptGHSolutionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.AcceptGHSolutionResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.AcceptGHSolutionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.AcceptGHSolutionResponse res = resBuilder.build();
