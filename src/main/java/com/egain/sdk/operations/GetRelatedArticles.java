...
public class GetRelatedArticles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRelatedArticlesRequest, GetRelatedArticlesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRelatedArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedArticlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRelatedArticlesRequest request) {
        ...
        @Override
        public GetRelatedArticlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRelatedArticlesResponse.Builder resBuilder =
            ...
            GetRelatedArticlesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRelatedArticlesRequest, com.egain.sdk.models.operations.async.GetRelatedArticlesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRelatedArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedArticlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRelatedArticlesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetRelatedArticlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetRelatedArticlesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetRelatedArticlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetRelatedArticlesResponse res = resBuilder.build();
