...
public class GetAcknowledgedComplianceArticles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAcknowledgedComplianceArticlesRequest, GetAcknowledgedComplianceArticlesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAcknowledgedComplianceArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAcknowledgedComplianceArticlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAcknowledgedComplianceArticlesRequest request) {
        ...
        @Override
        public GetAcknowledgedComplianceArticlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAcknowledgedComplianceArticlesResponse.Builder resBuilder =
                    GetAcknowledgedComplianceArticlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAcknowledgedComplianceArticlesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withComplianceArticleResults(Utils.unmarshal(response, new TypeReference<ComplianceArticleResults>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAcknowledgedComplianceArticlesRequest, com.egain.sdk.models.operations.async.GetAcknowledgedComplianceArticlesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAcknowledgedComplianceArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAcknowledgedComplianceArticlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAcknowledgedComplianceArticlesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAcknowledgedComplianceArticlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAcknowledgedComplianceArticlesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAcknowledgedComplianceArticlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAcknowledgedComplianceArticlesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ComplianceArticleResults>() {})
                            .thenApply(res::withComplianceArticleResults);
                } else {
