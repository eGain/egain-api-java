...
public class GetTopicBreadcrumbForArticle {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTopicBreadcrumbForArticleRequest, GetTopicBreadcrumbForArticleResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTopicBreadcrumbForArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTopicBreadcrumbForArticleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTopicBreadcrumbForArticleRequest request) {
        ...
        @Override
        public GetTopicBreadcrumbForArticleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTopicBreadcrumbForArticleResponse.Builder resBuilder =
                    GetTopicBreadcrumbForArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetTopicBreadcrumbForArticleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTopicBreadcrumbForArticleRequest, com.egain.sdk.models.operations.async.GetTopicBreadcrumbForArticleResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTopicBreadcrumbForArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTopicBreadcrumbForArticleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTopicBreadcrumbForArticleRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetTopicBreadcrumbForArticleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetTopicBreadcrumbForArticleResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetTopicBreadcrumbForArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetTopicBreadcrumbForArticleResponse res = resBuilder.build();
