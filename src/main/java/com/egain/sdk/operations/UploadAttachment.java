...
public class UploadAttachment {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadAttachmentRequest, UploadAttachmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UploadAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadAttachmentRequest.class, new TypeReference<UploadAttachmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadAttachmentRequest request) {
        ...
        @Override
        public UploadAttachmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadAttachmentResponse.Builder resBuilder =
            ...
            UploadAttachmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UploadAttachmentRequest, com.egain.sdk.models.operations.async.UploadAttachmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UploadAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadAttachmentRequest.class, new TypeReference<UploadAttachmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UploadAttachmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.UploadAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.UploadAttachmentResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.UploadAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.UploadAttachmentResponse res = resBuilder.build();
