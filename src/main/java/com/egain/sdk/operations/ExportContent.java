...
public class ExportContent {
    ...
    public static class Sync extends Base
        ...
        @Override
        public ExportContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ExportContentResponse.Builder resBuilder =
            ...
            ExportContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.ExportContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.ExportContentResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.ExportContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.ExportContentResponse res = resBuilder.build();
