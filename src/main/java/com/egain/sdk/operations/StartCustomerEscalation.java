...
public class StartCustomerEscalation {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartCustomerEscalationRequest, StartCustomerEscalationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(StartCustomerEscalationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartCustomerEscalationRequest.class, new TypeReference<StartCustomerEscalationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartCustomerEscalationRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "406", "415", "4XX", "500", "5XX")) {
        ...
        @Override
        public StartCustomerEscalationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartCustomerEscalationResponse.Builder resBuilder =
            ...
            StartCustomerEscalationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartCustomerEscalationRequest, com.egain.sdk.models.operations.async.StartCustomerEscalationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StartCustomerEscalationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartCustomerEscalationRequest.class, new TypeReference<StartCustomerEscalationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartCustomerEscalationRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "403", "406", "415", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.StartCustomerEscalationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.StartCustomerEscalationResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.StartCustomerEscalationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.StartCustomerEscalationResponse res = resBuilder.build();
