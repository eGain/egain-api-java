...
public class GetArticlePermissionsById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticlePermissionsByIdRequest, GetArticlePermissionsByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticlePermissionsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticlePermissionsByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticlePermissionsByIdRequest request) {
        ...
        @Override
        public GetArticlePermissionsByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticlePermissionsByIdResponse.Builder resBuilder =
                    GetArticlePermissionsByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetArticlePermissionsByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticlePermissionsResult(Utils.unmarshal(response, new TypeReference<ArticlePermissionsResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticlePermissionsByIdRequest, com.egain.sdk.models.operations.async.GetArticlePermissionsByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticlePermissionsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticlePermissionsByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticlePermissionsByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticlePermissionsByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticlePermissionsByIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticlePermissionsByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticlePermissionsByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ArticlePermissionsResult>() {})
                            .thenApply(res::withArticlePermissionsResult);
                } else {
