...
public class AddToReply {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddToReplyRequest, AddToReplyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddToReplyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddToReplyRequest.class, new TypeReference<AddToReplyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddToReplyRequest request) {
        ...
        @Override
        public AddToReplyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddToReplyResponse.Builder resBuilder =
                    AddToReplyResponse
                            .builder()
            ...
            AddToReplyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddToReplyRequest, com.egain.sdk.models.operations.async.AddToReplyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddToReplyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddToReplyRequest.class, new TypeReference<AddToReplyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddToReplyRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.AddToReplyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.AddToReplyResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.AddToReplyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.AddToReplyResponse res = resBuilder.build();
