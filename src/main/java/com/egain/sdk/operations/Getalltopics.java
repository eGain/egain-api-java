...
public class Getalltopics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetalltopicsRequest, GetalltopicsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetalltopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetalltopicsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetalltopicsRequest request) {
        ...
        @Override
        public GetalltopicsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetalltopicsResponse.Builder resBuilder =
            ...
            GetalltopicsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetalltopicsRequest, com.egain.sdk.models.operations.async.GetalltopicsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetalltopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetalltopicsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetalltopicsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetalltopicsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetalltopicsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetalltopicsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetalltopicsResponse res = resBuilder.build();
