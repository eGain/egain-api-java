...
public class RestoreQuickpick {
    ...
    public static class Sync extends Base
            implements RequestOperation<RestoreQuickpickRequest, RestoreQuickpickResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RestoreQuickpickRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RestoreQuickpickRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RestoreQuickpickRequest request) {
        ...
        @Override
        public RestoreQuickpickResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RestoreQuickpickResponse.Builder resBuilder =
                    RestoreQuickpickResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            RestoreQuickpickResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RestoreQuickpickRequest, com.egain.sdk.models.operations.async.RestoreQuickpickResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RestoreQuickpickRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RestoreQuickpickRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RestoreQuickpickRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.RestoreQuickpickResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.RestoreQuickpickResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.RestoreQuickpickResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.RestoreQuickpickResponse res = resBuilder.build();
