...
import com.egain.sdk.models.components.Article;
...
public class GetArticleById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticleByIdRequest, GetArticleByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticleByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticleByIdRequest request) {
        ...
        @Override
        public GetArticleByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticleByIdResponse.Builder resBuilder =
            ...
            GetArticleByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticle(Utils.unmarshal(response, new TypeReference<Article>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticleByIdRequest, com.egain.sdk.models.operations.async.GetArticleByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticleByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticleByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticleByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticleByIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticleByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticleByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Article>() {})
                            .thenApply(res::withArticle);
                } else {
