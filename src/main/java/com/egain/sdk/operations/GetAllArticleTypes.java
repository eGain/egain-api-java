...
import com.egain.sdk.models.components.ArticleTypeInfo;
...
public class GetAllArticleTypes {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllArticleTypesRequest, GetAllArticleTypesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllArticleTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllArticleTypesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllArticleTypesRequest request) {
        ...
        @Override
        public GetAllArticleTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllArticleTypesResponse.Builder resBuilder =
            ...
            GetAllArticleTypesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticleTypes(Utils.unmarshal(response, new TypeReference<List<ArticleTypeInfo>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllArticleTypesRequest, com.egain.sdk.models.operations.async.GetAllArticleTypesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllArticleTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllArticleTypesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllArticleTypesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllArticleTypesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllArticleTypesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllArticleTypesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllArticleTypesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ArticleTypeInfo>>() {})
                            .thenApply(res::withArticleTypes);
                } else {
