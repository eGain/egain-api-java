...
public class ModifySuggestions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ModifySuggestionsRequest, ModifySuggestionsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ModifySuggestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ModifySuggestionsRequest.class, new TypeReference<ModifySuggestionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ModifySuggestionsRequest request) {
        ...
        @Override
        public ModifySuggestionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ModifySuggestionsResponse.Builder resBuilder =
                    ModifySuggestionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ModifySuggestionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ModifySuggestionsRequest, com.egain.sdk.models.operations.async.ModifySuggestionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ModifySuggestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ModifySuggestionsRequest.class, new TypeReference<ModifySuggestionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ModifySuggestionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.ModifySuggestionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.ModifySuggestionsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.ModifySuggestionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.ModifySuggestionsResponse res = resBuilder.build();
