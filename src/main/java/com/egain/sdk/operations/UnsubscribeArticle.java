...
public class UnsubscribeArticle {
    ...
    public static class Sync extends Base
            implements RequestOperation<UnsubscribeArticleRequest, UnsubscribeArticleResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UnsubscribeArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnsubscribeArticleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnsubscribeArticleRequest request) {
        ...
        @Override
        public UnsubscribeArticleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnsubscribeArticleResponse.Builder resBuilder =
                    UnsubscribeArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UnsubscribeArticleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnsubscribeArticleRequest, com.egain.sdk.models.operations.async.UnsubscribeArticleResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UnsubscribeArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnsubscribeArticleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnsubscribeArticleRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.UnsubscribeArticleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.UnsubscribeArticleResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.UnsubscribeArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.UnsubscribeArticleResponse res = resBuilder.build();
