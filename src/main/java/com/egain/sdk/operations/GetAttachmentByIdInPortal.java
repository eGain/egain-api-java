...
public class GetAttachmentByIdInPortal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAttachmentByIdInPortalRequest, GetAttachmentByIdInPortalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAttachmentByIdInPortalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttachmentByIdInPortalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAttachmentByIdInPortalRequest request) {
        ...
        @Override
        public GetAttachmentByIdInPortalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAttachmentByIdInPortalResponse.Builder resBuilder =
                    GetAttachmentByIdInPortalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAttachmentByIdInPortalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttachmentContentResult(Utils.unmarshal(response, new TypeReference<AttachmentContentResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAttachmentByIdInPortalRequest, com.egain.sdk.models.operations.async.GetAttachmentByIdInPortalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAttachmentByIdInPortalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttachmentByIdInPortalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAttachmentByIdInPortalRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAttachmentByIdInPortalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAttachmentByIdInPortalResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAttachmentByIdInPortalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAttachmentByIdInPortalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttachmentContentResult>() {})
                            .thenApply(res::withAttachmentContentResult);
                } else {
