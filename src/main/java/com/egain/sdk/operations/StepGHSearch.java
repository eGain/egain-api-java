...
public class StepGHSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<StepGHSearchRequest, StepGHSearchResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(StepGHSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StepGHSearchRequest.class, new TypeReference<StepGHSearchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StepGHSearchRequest request) {
        ...
        @Override
        public StepGHSearchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StepGHSearchResponse.Builder resBuilder =
                    StepGHSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            StepGHSearchResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StepGHSearchRequest, com.egain.sdk.models.operations.async.StepGHSearchResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StepGHSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StepGHSearchRequest.class, new TypeReference<StepGHSearchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StepGHSearchRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.StepGHSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.StepGHSearchResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.StepGHSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.StepGHSearchResponse res = resBuilder.build();
