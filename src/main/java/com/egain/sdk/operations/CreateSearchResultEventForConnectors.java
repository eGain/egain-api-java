...
public class CreateSearchResultEventForConnectors {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSearchResultEventForConnectorsRequest, CreateSearchResultEventForConnectorsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSearchResultEventForConnectorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSearchResultEventForConnectorsRequest.class, new TypeReference<CreateSearchResultEventForConnectorsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSearchResultEventForConnectorsRequest request) {
        ...
        @Override
        public CreateSearchResultEventForConnectorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSearchResultEventForConnectorsResponse.Builder resBuilder =
                    CreateSearchResultEventForConnectorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateSearchResultEventForConnectorsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSearchResultEventForConnectorsRequest, com.egain.sdk.models.operations.async.CreateSearchResultEventForConnectorsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSearchResultEventForConnectorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSearchResultEventForConnectorsRequest.class, new TypeReference<CreateSearchResultEventForConnectorsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSearchResultEventForConnectorsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.CreateSearchResultEventForConnectorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.CreateSearchResultEventForConnectorsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.CreateSearchResultEventForConnectorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.CreateSearchResultEventForConnectorsResponse res = resBuilder.build();
