...
public class GetMyPortals {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMyPortalsRequest, GetMyPortalsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMyPortalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMyPortalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMyPortalsRequest request) {
        ...
        @Override
        public GetMyPortalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMyPortalsResponse.Builder resBuilder =
            ...
            GetMyPortalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAllAccessiblePortals(Utils.unmarshal(response, new TypeReference<AllAccessiblePortals>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMyPortalsRequest, com.egain.sdk.models.operations.async.GetMyPortalsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMyPortalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMyPortalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMyPortalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetMyPortalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetMyPortalsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetMyPortalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetMyPortalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AllAccessiblePortals>() {})
                            .thenApply(res::withAllAccessiblePortals);
                } else {
