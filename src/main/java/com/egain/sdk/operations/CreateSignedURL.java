...
public class CreateSignedURL {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSignedURLRequest, CreateSignedURLResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSignedURLRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateSignedURLRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSignedURLRequest request) {
        ...
        @Override
        public CreateSignedURLResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSignedURLResponse.Builder resBuilder =
            ...
            CreateSignedURLResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSignedURLRequest, com.egain.sdk.models.operations.async.CreateSignedURLResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSignedURLRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateSignedURLRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSignedURLRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.CreateSignedURLResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.CreateSignedURLResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.CreateSignedURLResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.CreateSignedURLResponse res = resBuilder.build();
