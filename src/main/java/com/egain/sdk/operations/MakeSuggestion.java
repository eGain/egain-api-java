...
public class MakeSuggestion {
    ...
    public static class Sync extends Base
            implements RequestOperation<MakeSuggestionRequest, MakeSuggestionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(MakeSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MakeSuggestionRequest.class, new TypeReference<MakeSuggestionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MakeSuggestionRequest request) {
        ...
        @Override
        public MakeSuggestionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MakeSuggestionResponse.Builder resBuilder =
            ...
            MakeSuggestionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MakeSuggestionRequest, com.egain.sdk.models.operations.async.MakeSuggestionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(MakeSuggestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MakeSuggestionRequest.class, new TypeReference<MakeSuggestionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MakeSuggestionRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.MakeSuggestionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.MakeSuggestionResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.MakeSuggestionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.MakeSuggestionResponse res = resBuilder.build();
