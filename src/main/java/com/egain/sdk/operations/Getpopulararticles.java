...
public class Getpopulararticles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetpopulararticlesRequest, GetpopulararticlesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetpopulararticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetpopulararticlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetpopulararticlesRequest request) {
        ...
        @Override
        public GetpopulararticlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetpopulararticlesResponse.Builder resBuilder =
            ...
            GetpopulararticlesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetpopulararticlesRequest, com.egain.sdk.models.operations.async.GetpopulararticlesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetpopulararticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetpopulararticlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetpopulararticlesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetpopulararticlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetpopulararticlesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetpopulararticlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetpopulararticlesResponse res = resBuilder.build();
