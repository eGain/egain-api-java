...
public class GetAllCases {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllCasesRequest, GetAllCasesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllCasesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllCasesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllCasesRequest request) {
        ...
        @Override
        public GetAllCasesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllCasesResponse.Builder resBuilder =
                    GetAllCasesResponse
                            .builder()
            ...
            GetAllCasesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCaseListResults(Utils.unmarshal(response, new TypeReference<CaseListResults>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllCasesRequest, com.egain.sdk.models.operations.async.GetAllCasesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllCasesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllCasesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllCasesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllCasesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllCasesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllCasesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllCasesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CaseListResults>() {})
                            .thenApply(res::withCaseListResults);
                } else {
