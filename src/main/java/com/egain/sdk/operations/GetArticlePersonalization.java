...
public class GetArticlePersonalization {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticlePersonalizationRequest, GetArticlePersonalizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticlePersonalizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticlePersonalizationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticlePersonalizationRequest request) {
        ...
        @Override
        public GetArticlePersonalizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticlePersonalizationResponse.Builder resBuilder =
                    GetArticlePersonalizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetArticlePersonalizationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPersonalization(Utils.unmarshal(response, new TypeReference<Personalization>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticlePersonalizationRequest, com.egain.sdk.models.operations.async.GetArticlePersonalizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticlePersonalizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticlePersonalizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticlePersonalizationRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticlePersonalizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticlePersonalizationResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticlePersonalizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticlePersonalizationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Personalization>() {})
                            .thenApply(res::withPersonalization);
                } else {
