...
public class Getancestortopics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetancestortopicsRequest, GetancestortopicsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetancestortopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetancestortopicsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetancestortopicsRequest request) {
        ...
        @Override
        public GetancestortopicsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetancestortopicsResponse.Builder resBuilder =
                    GetancestortopicsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetancestortopicsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTopicResult(Utils.unmarshal(response, new TypeReference<TopicResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetancestortopicsRequest, com.egain.sdk.models.operations.async.GetancestortopicsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetancestortopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetancestortopicsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetancestortopicsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetancestortopicsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetancestortopicsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetancestortopicsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetancestortopicsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TopicResult>() {})
                            .thenApply(res::withTopicResult);
                } else {
