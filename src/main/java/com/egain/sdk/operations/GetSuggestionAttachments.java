...
public class GetSuggestionAttachments {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSuggestionAttachmentsRequest, GetSuggestionAttachmentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSuggestionAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionAttachmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSuggestionAttachmentsRequest request) {
        ...
        @Override
        public GetSuggestionAttachmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSuggestionAttachmentsResponse.Builder resBuilder =
                    GetSuggestionAttachmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetSuggestionAttachmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttachments(Utils.unmarshal(response, new TypeReference<Attachments>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSuggestionAttachmentsRequest, com.egain.sdk.models.operations.async.GetSuggestionAttachmentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSuggestionAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionAttachmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSuggestionAttachmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetSuggestionAttachmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetSuggestionAttachmentsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetSuggestionAttachmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetSuggestionAttachmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Attachments>() {})
                            .thenApply(res::withAttachments);
                } else {
