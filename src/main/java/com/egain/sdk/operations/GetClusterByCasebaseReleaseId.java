...
import com.egain.sdk.models.components.ClusterResults;
...
public class GetClusterByCasebaseReleaseId {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClusterByCasebaseReleaseIdRequest, GetClusterByCasebaseReleaseIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClusterByCasebaseReleaseIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClusterByCasebaseReleaseIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClusterByCasebaseReleaseIdRequest request) {
        ...
        @Override
        public GetClusterByCasebaseReleaseIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClusterByCasebaseReleaseIdResponse.Builder resBuilder =
            ...
            GetClusterByCasebaseReleaseIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClusterResults(Utils.unmarshal(response, new TypeReference<ClusterResults>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClusterByCasebaseReleaseIdRequest, com.egain.sdk.models.operations.async.GetClusterByCasebaseReleaseIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClusterByCasebaseReleaseIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClusterByCasebaseReleaseIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClusterByCasebaseReleaseIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetClusterByCasebaseReleaseIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetClusterByCasebaseReleaseIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetClusterByCasebaseReleaseIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetClusterByCasebaseReleaseIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ClusterResults>() {})
                            .thenApply(res::withClusterResults);
                } else {
