...
public class GetCasebaseReleaseById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCasebaseReleaseByIdRequest, GetCasebaseReleaseByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCasebaseReleaseByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCasebaseReleaseByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCasebaseReleaseByIdRequest request) {
        ...
        @Override
        public GetCasebaseReleaseByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCasebaseReleaseByIdResponse.Builder resBuilder =
            ...
            GetCasebaseReleaseByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCasebaseReleaseByIdRequest, com.egain.sdk.models.operations.async.GetCasebaseReleaseByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCasebaseReleaseByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCasebaseReleaseByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCasebaseReleaseByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetCasebaseReleaseByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetCasebaseReleaseByIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetCasebaseReleaseByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetCasebaseReleaseByIdResponse res = resBuilder.build();
