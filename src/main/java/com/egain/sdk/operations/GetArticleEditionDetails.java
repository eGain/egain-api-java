...
public class GetArticleEditionDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticleEditionDetailsRequest, GetArticleEditionDetailsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticleEditionDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleEditionDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticleEditionDetailsRequest request) {
        ...
        @Override
        public GetArticleEditionDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticleEditionDetailsResponse.Builder resBuilder =
                    GetArticleEditionDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetArticleEditionDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEditionWithContent(Utils.unmarshal(response, new TypeReference<EditionWithContent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticleEditionDetailsRequest, com.egain.sdk.models.operations.async.GetArticleEditionDetailsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticleEditionDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleEditionDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticleEditionDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticleEditionDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticleEditionDetailsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticleEditionDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticleEditionDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EditionWithContent>() {})
                            .thenApply(res::withEditionWithContent);
                } else {
