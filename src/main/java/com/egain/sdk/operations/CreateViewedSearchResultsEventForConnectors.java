...
public class CreateViewedSearchResultsEventForConnectors {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateViewedSearchResultsEventForConnectorsRequest, CreateViewedSearchResultsEventForConnectorsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateViewedSearchResultsEventForConnectorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateViewedSearchResultsEventForConnectorsRequest.class, new TypeReference<CreateViewedSearchResultsEventForConnectorsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateViewedSearchResultsEventForConnectorsRequest request) {
        ...
        @Override
        public CreateViewedSearchResultsEventForConnectorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateViewedSearchResultsEventForConnectorsResponse.Builder resBuilder =
                    CreateViewedSearchResultsEventForConnectorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateViewedSearchResultsEventForConnectorsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateViewedSearchResultsEventForConnectorsRequest, com.egain.sdk.models.operations.async.CreateViewedSearchResultsEventForConnectorsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateViewedSearchResultsEventForConnectorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateViewedSearchResultsEventForConnectorsRequest.class, new TypeReference<CreateViewedSearchResultsEventForConnectorsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateViewedSearchResultsEventForConnectorsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.CreateViewedSearchResultsEventForConnectorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.CreateViewedSearchResultsEventForConnectorsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.CreateViewedSearchResultsEventForConnectorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.CreateViewedSearchResultsEventForConnectorsResponse res = resBuilder.build();
