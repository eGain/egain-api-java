...
import com.egain.sdk.models.components.ArticleRatingsResponse;
...
public class GetArticleRatings {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticleRatingsRequest, GetArticleRatingsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticleRatingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleRatingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticleRatingsRequest request) {
        ...
        @Override
        public GetArticleRatingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticleRatingsResponse.Builder resBuilder =
            ...
            GetArticleRatingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticleRatingsResponse(Utils.unmarshal(response, new TypeReference<ArticleRatingsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticleRatingsRequest, com.egain.sdk.models.operations.async.GetArticleRatingsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticleRatingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleRatingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticleRatingsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticleRatingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticleRatingsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticleRatingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticleRatingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ArticleRatingsResponse>() {})
                            .thenApply(res::withArticleRatingsResponse);
                } else {
