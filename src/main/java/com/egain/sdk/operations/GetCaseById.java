...
public class GetCaseById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCaseByIdRequest, GetCaseByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCaseByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCaseByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCaseByIdRequest request) {
        ...
        @Override
        public GetCaseByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCaseByIdResponse.Builder resBuilder =
                    GetCaseByIdResponse
                            .builder()
            ...
            GetCaseByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCase(Utils.unmarshal(response, new TypeReference<Case>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCaseByIdRequest, com.egain.sdk.models.operations.async.GetCaseByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCaseByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCaseByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCaseByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetCaseByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetCaseByIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetCaseByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetCaseByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Case>() {})
                            .thenApply(res::withCase);
                } else {
