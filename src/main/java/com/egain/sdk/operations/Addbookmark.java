...
public class Addbookmark {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddbookmarkRequest, AddbookmarkResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddbookmarkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddbookmarkRequest.class, new TypeReference<AddbookmarkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddbookmarkRequest request) {
        ...
        @Override
        public AddbookmarkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddbookmarkResponse.Builder resBuilder =
                    AddbookmarkResponse
                            .builder()
            ...
            AddbookmarkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddbookmarkRequest, com.egain.sdk.models.operations.async.AddbookmarkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddbookmarkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddbookmarkRequest.class, new TypeReference<AddbookmarkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddbookmarkRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.AddbookmarkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.AddbookmarkResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.AddbookmarkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.AddbookmarkResponse res = resBuilder.build();
