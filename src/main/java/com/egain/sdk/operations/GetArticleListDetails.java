...
import com.egain.sdk.models.components.ArticleList;
...
public class GetArticleListDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticleListDetailsRequest, GetArticleListDetailsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticleListDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleListDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticleListDetailsRequest request) {
        ...
        @Override
        public GetArticleListDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticleListDetailsResponse.Builder resBuilder =
                    GetArticleListDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetArticleListDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticleList(Utils.unmarshal(response, new TypeReference<ArticleList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticleListDetailsRequest, com.egain.sdk.models.operations.async.GetArticleListDetailsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticleListDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleListDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticleListDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticleListDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticleListDetailsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticleListDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticleListDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ArticleList>() {})
                            .thenApply(res::withArticleList);
                } else {
