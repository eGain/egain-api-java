...
public class GetPendingComplianceArticles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPendingComplianceArticlesRequest, GetPendingComplianceArticlesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPendingComplianceArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPendingComplianceArticlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPendingComplianceArticlesRequest request) {
        ...
        @Override
        public GetPendingComplianceArticlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPendingComplianceArticlesResponse.Builder resBuilder =
                    GetPendingComplianceArticlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetPendingComplianceArticlesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPendingComplianceArticlesRequest, com.egain.sdk.models.operations.async.GetPendingComplianceArticlesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPendingComplianceArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPendingComplianceArticlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPendingComplianceArticlesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetPendingComplianceArticlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetPendingComplianceArticlesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetPendingComplianceArticlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetPendingComplianceArticlesResponse res = resBuilder.build();
