...
public class ComplyArticle {
    ...
    public static class Sync extends Base
            implements RequestOperation<ComplyArticleRequest, ComplyArticleResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ComplyArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ComplyArticleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ComplyArticleRequest request) {
        ...
        @Override
        public ComplyArticleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ComplyArticleResponse.Builder resBuilder =
                    ComplyArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ComplyArticleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ComplyArticleRequest, com.egain.sdk.models.operations.async.ComplyArticleResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ComplyArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ComplyArticleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ComplyArticleRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.ComplyArticleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.ComplyArticleResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.ComplyArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.ComplyArticleResponse res = resBuilder.build();
