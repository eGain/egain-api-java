...
public class AvertCustomerEscalation {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/portals/{portalID}/escalate/{escalationId}/avert",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<AvertCustomerEscalationRequest, AvertCustomerEscalationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AvertCustomerEscalationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AvertCustomerEscalationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AvertCustomerEscalationRequest request) {
        ...
        @Override
        public AvertCustomerEscalationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AvertCustomerEscalationResponse.Builder resBuilder =
                    AvertCustomerEscalationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AvertCustomerEscalationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AvertCustomerEscalationRequest, com.egain.sdk.models.operations.async.AvertCustomerEscalationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AvertCustomerEscalationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AvertCustomerEscalationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AvertCustomerEscalationRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.AvertCustomerEscalationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.AvertCustomerEscalationResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.AvertCustomerEscalationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.AvertCustomerEscalationResponse res = resBuilder.build();
