...
public class GetAllProfilesInPortal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllProfilesInPortalRequest, GetAllProfilesInPortalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAllProfilesInPortalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllProfilesInPortalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllProfilesInPortalRequest request) {
        ...
        @Override
        public GetAllProfilesInPortalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllProfilesInPortalResponse.Builder resBuilder =
                    GetAllProfilesInPortalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAllProfilesInPortalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProfileResult(Utils.unmarshal(response, new TypeReference<ProfileResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllProfilesInPortalRequest, com.egain.sdk.models.operations.async.GetAllProfilesInPortalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllProfilesInPortalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllProfilesInPortalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllProfilesInPortalRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAllProfilesInPortalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAllProfilesInPortalResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAllProfilesInPortalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAllProfilesInPortalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProfileResult>() {})
                            .thenApply(res::withProfileResult);
                } else {
