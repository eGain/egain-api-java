...
public class GetArticleByIdWithEditions {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArticleByIdWithEditionsRequest, GetArticleByIdWithEditionsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetArticleByIdWithEditionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleByIdWithEditionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArticleByIdWithEditionsRequest request) {
        ...
        @Override
        public GetArticleByIdWithEditionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArticleByIdWithEditionsResponse.Builder resBuilder =
                    GetArticleByIdWithEditionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetArticleByIdWithEditionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticleWithEditions(Utils.unmarshal(response, new TypeReference<ArticleWithEditions>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArticleByIdWithEditionsRequest, com.egain.sdk.models.operations.async.GetArticleByIdWithEditionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetArticleByIdWithEditionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArticleByIdWithEditionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArticleByIdWithEditionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetArticleByIdWithEditionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetArticleByIdWithEditionsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetArticleByIdWithEditionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetArticleByIdWithEditionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ArticleWithEditions>() {})
                            .thenApply(res::withArticleWithEditions);
                } else {
