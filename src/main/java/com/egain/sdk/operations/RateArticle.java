...
public class RateArticle {
    ...
    public static class Sync extends Base
            implements RequestOperation<RateArticleRequest, RateArticleResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RateArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RateArticleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RateArticleRequest request) {
        ...
        @Override
        public RateArticleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RateArticleResponse.Builder resBuilder =
                    RateArticleResponse
                            .builder()
            ...
            RateArticleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RateArticleRequest, com.egain.sdk.models.operations.async.RateArticleResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RateArticleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RateArticleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RateArticleRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.RateArticleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.RateArticleResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.RateArticleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.RateArticleResponse res = resBuilder.build();
