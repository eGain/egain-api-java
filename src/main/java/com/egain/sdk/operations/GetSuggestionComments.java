...
public class GetSuggestionComments {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSuggestionCommentsRequest, GetSuggestionCommentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSuggestionCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionCommentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSuggestionCommentsRequest request) {
        ...
        @Override
        public GetSuggestionCommentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSuggestionCommentsResponse.Builder resBuilder =
            ...
            GetSuggestionCommentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withComments(Utils.unmarshal(response, new TypeReference<Comments>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSuggestionCommentsRequest, com.egain.sdk.models.operations.async.GetSuggestionCommentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSuggestionCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSuggestionCommentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSuggestionCommentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetSuggestionCommentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetSuggestionCommentsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetSuggestionCommentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetSuggestionCommentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Comments>() {})
                            .thenApply(res::withComments);
                } else {
