...
public class CreateFederatedSearchResultEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateFederatedSearchResultEventRequest, CreateFederatedSearchResultEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateFederatedSearchResultEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFederatedSearchResultEventRequest.class, new TypeReference<CreateFederatedSearchResultEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateFederatedSearchResultEventRequest request) {
        ...
        @Override
        public CreateFederatedSearchResultEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateFederatedSearchResultEventResponse.Builder resBuilder =
                    CreateFederatedSearchResultEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateFederatedSearchResultEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateFederatedSearchResultEventRequest, com.egain.sdk.models.operations.async.CreateFederatedSearchResultEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateFederatedSearchResultEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFederatedSearchResultEventRequest.class, new TypeReference<CreateFederatedSearchResultEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateFederatedSearchResultEventRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.CreateFederatedSearchResultEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.CreateFederatedSearchResultEventResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.CreateFederatedSearchResultEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.CreateFederatedSearchResultEventResponse res = resBuilder.build();
