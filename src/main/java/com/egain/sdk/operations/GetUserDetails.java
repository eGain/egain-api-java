...
import com.egain.sdk.models.components.UserDetails;
...
public class GetUserDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUserDetailsRequest, GetUserDetailsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUserDetailsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserDetailsRequest request) {
        ...
        @Override
        public GetUserDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUserDetailsResponse.Builder resBuilder =
            ...
            GetUserDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUserDetails(Utils.unmarshal(response, new TypeReference<UserDetails>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUserDetailsRequest, com.egain.sdk.models.operations.async.GetUserDetailsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUserDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUserDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetUserDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetUserDetailsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetUserDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetUserDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UserDetails>() {})
                            .thenApply(res::withUserDetails);
                } else {
