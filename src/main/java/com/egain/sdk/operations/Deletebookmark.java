...
public class Deletebookmark {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletebookmarkRequest, DeletebookmarkResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletebookmarkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletebookmarkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletebookmarkRequest request) {
        ...
        @Override
        public DeletebookmarkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletebookmarkResponse.Builder resBuilder =
            ...
            DeletebookmarkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletebookmarkRequest, com.egain.sdk.models.operations.async.DeletebookmarkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletebookmarkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletebookmarkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletebookmarkRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.DeletebookmarkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.DeletebookmarkResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.DeletebookmarkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.DeletebookmarkResponse res = resBuilder.build();
