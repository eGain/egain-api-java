...
import com.egain.sdk.models.components.TopicTreeResult;
...
public class Getchildtopics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetchildtopicsRequest, GetchildtopicsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetchildtopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetchildtopicsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetchildtopicsRequest request) {
        ...
        @Override
        public GetchildtopicsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetchildtopicsResponse.Builder resBuilder =
                    GetchildtopicsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetchildtopicsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTopicTreeResult(Utils.unmarshal(response, new TypeReference<TopicTreeResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetchildtopicsRequest, com.egain.sdk.models.operations.async.GetchildtopicsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetchildtopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetchildtopicsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetchildtopicsRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetchildtopicsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetchildtopicsResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetchildtopicsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetchildtopicsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TopicTreeResult>() {})
                            .thenApply(res::withTopicTreeResult);
                } else {
