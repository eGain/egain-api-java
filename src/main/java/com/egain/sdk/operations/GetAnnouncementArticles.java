...
public class GetAnnouncementArticles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnnouncementArticlesRequest, GetAnnouncementArticlesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnnouncementArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnnouncementArticlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnnouncementArticlesRequest request) {
        ...
        @Override
        public GetAnnouncementArticlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnnouncementArticlesResponse.Builder resBuilder =
            ...
            GetAnnouncementArticlesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withArticleResults(Utils.unmarshal(response, new TypeReference<ArticleResults>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnnouncementArticlesRequest, com.egain.sdk.models.operations.async.GetAnnouncementArticlesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnnouncementArticlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnnouncementArticlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnnouncementArticlesRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetAnnouncementArticlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetAnnouncementArticlesResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetAnnouncementArticlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetAnnouncementArticlesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ArticleResults>() {})
                            .thenApply(res::withArticleResults);
                } else {
