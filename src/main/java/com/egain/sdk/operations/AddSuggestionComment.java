...
public class AddSuggestionComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddSuggestionCommentRequest, AddSuggestionCommentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddSuggestionCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSuggestionCommentRequest.class, new TypeReference<AddSuggestionCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSuggestionCommentRequest request) {
        ...
        @Override
        public AddSuggestionCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddSuggestionCommentResponse.Builder resBuilder =
                    AddSuggestionCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AddSuggestionCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddSuggestionCommentRequest, com.egain.sdk.models.operations.async.AddSuggestionCommentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddSuggestionCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSuggestionCommentRequest.class, new TypeReference<AddSuggestionCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddSuggestionCommentRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.AddSuggestionCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.AddSuggestionCommentResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.AddSuggestionCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.AddSuggestionCommentResponse res = resBuilder.build();
