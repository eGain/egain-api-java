...
public class GetPortalDetailsById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPortalDetailsByIdRequest, GetPortalDetailsByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPortalDetailsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPortalDetailsByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPortalDetailsByIdRequest request) {
        ...
        @Override
        public GetPortalDetailsByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPortalDetailsByIdResponse.Builder resBuilder =
                    GetPortalDetailsByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetPortalDetailsByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPortal(Utils.unmarshal(response, new TypeReference<Portal>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPortalDetailsByIdRequest, com.egain.sdk.models.operations.async.GetPortalDetailsByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPortalDetailsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPortalDetailsByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPortalDetailsByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetPortalDetailsByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetPortalDetailsByIdResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetPortalDetailsByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetPortalDetailsByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Portal>() {})
                            .thenApply(res::withPortal);
                } else {
