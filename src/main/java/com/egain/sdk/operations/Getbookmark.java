...
public class Getbookmark {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetbookmarkRequest, GetbookmarkResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetbookmarkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetbookmarkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetbookmarkRequest request) {
        ...
        @Override
        public GetbookmarkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetbookmarkResponse.Builder resBuilder =
                    GetbookmarkResponse
                            .builder()
            ...
            GetbookmarkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBookmarkResult(Utils.unmarshal(response, new TypeReference<BookmarkResult>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetbookmarkRequest, com.egain.sdk.models.operations.async.GetbookmarkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetbookmarkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetbookmarkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetbookmarkRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetbookmarkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetbookmarkResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetbookmarkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetbookmarkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BookmarkResult>() {})
                            .thenApply(res::withBookmarkResult);
                } else {
