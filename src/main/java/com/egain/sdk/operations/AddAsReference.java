...
public class AddAsReference {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddAsReferenceRequest, AddAsReferenceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddAsReferenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddAsReferenceRequest.class, new TypeReference<AddAsReferenceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddAsReferenceRequest request) {
        ...
        @Override
        public AddAsReferenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddAsReferenceResponse.Builder resBuilder =
                    AddAsReferenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AddAsReferenceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddAsReferenceRequest, com.egain.sdk.models.operations.async.AddAsReferenceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddAsReferenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddAsReferenceRequest.class, new TypeReference<AddAsReferenceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddAsReferenceRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.AddAsReferenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.AddAsReferenceResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.AddAsReferenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.AddAsReferenceResponse res = resBuilder.build();
