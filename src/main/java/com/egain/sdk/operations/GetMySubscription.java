...
public class GetMySubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMySubscriptionRequest, GetMySubscriptionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMySubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMySubscriptionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMySubscriptionRequest request) {
        ...
        @Override
        public GetMySubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMySubscriptionResponse.Builder resBuilder =
            ...
            GetMySubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMySubscriptionRequest, com.egain.sdk.models.operations.async.GetMySubscriptionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMySubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMySubscriptionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMySubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<com.egain.sdk.models.operations.async.GetMySubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.egain.sdk.models.operations.async.GetMySubscriptionResponse.Builder resBuilder =
                    com.egain.sdk.models.operations.async.GetMySubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.egain.sdk.models.operations.async.GetMySubscriptionResponse res = resBuilder.build();
