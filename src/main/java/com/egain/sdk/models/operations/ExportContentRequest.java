...
public class ExportContentRequest {
    ...
    private KnowledgeExport body;

    @JsonCreator
    public ExportContentRequest(
            @Nonnull AcceptLanguage acceptLanguage,
            @Nonnull KnowledgeExport body) {
     ...
     * representation and in error responses).
     */
    public ExportContentRequest withAcceptLanguage(@Nonnull AcceptLanguage acceptLanguage) {
        this.acceptLanguage = Utils.checkNotNull(acceptLanguage, "acceptLanguage");
        return this;
    }


    public ExportContentRequest withBody(@Nonnull KnowledgeExport body) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExportContentRequest other = (ExportContentRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ExportContentRequest.class,
    ...
    public final static class Builder {
        ...
        public Builder body(@Nonnull KnowledgeExport body) {
            this.body = Utils.checkNotNull(body, "body");
            return this;
        }

        public ExportContentRequest build() {
            return new ExportContentRequest(
                acceptLanguage, body);
        }
