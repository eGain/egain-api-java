...
public class CreateQuickpickRequest {
    /**
    ...
    private CreateQuickpick body;

    @JsonCreator
    public CreateQuickpickRequest(
     ...
     * representation and in error responses).
     */
    public CreateQuickpickRequest withAcceptLanguage(@Nonnull AcceptLanguage acceptLanguage) {
     ...
     * by a dash and 4-15 digits.
     */
    public CreateQuickpickRequest withPortalID(@Nonnull String portalID) {
     ...
     * language is used.&lt;/li&gt;
     */
    public CreateQuickpickRequest withLanguage(@Nullable LanguageQueryParameter language) {
        this.language = language;
        return this;
    }


    public CreateQuickpickRequest withBody(@Nonnull CreateQuickpick body) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateQuickpickRequest other = (CreateQuickpickRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateQuickpickRequest.class,
    ...
    public final static class Builder {
        ...
        public Builder body(@Nonnull CreateQuickpick body) {
            this.body = Utils.checkNotNull(body, "body");
            return this;
        }

        public CreateQuickpickRequest build() {
            return new CreateQuickpickRequest(
                acceptLanguage, portalID, language,
                body);
        }
