...
public class AcceptGHSolutionRequest {
    /**
    ...
    @JsonCreator
    public AcceptGHSolutionRequest(
     ...
     * representation and in error responses).
     */
    public AcceptGHSolutionRequest withAcceptLanguage(@Nonnull AcceptLanguage acceptLanguage) {
     ...
     * by a dash and 4-15 digits.
     */
    public AcceptGHSolutionRequest withPortalID(@Nonnull String portalID) {
     ...
     * The numerical ID of the Case for which details is to be fetched.
     */
    public AcceptGHSolutionRequest withCaseID(@Nonnull String caseID) {
        this.caseID = Utils.checkNotNull(caseID, "caseID");
        return this;
    }


    public AcceptGHSolutionRequest withBody(@Nonnull QuickpickRating body) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AcceptGHSolutionRequest other = (AcceptGHSolutionRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AcceptGHSolutionRequest.class,
    ...
    public final static class Builder {
        ...
        public AcceptGHSolutionRequest build() {
            return new AcceptGHSolutionRequest(
                acceptLanguage, portalID, caseID,
                body);
        }
