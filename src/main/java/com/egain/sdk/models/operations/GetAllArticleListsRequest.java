...
public class GetAllArticleListsRequest {
    /**
    ...
    @JsonCreator
    public GetAllArticleListsRequest(
     ...
     * representation and in error responses).
     */
    public GetAllArticleListsRequest withAcceptLanguage(@Nonnull AcceptLanguage acceptLanguage) {
     ...
     * by a dash and 4-15 digits.
     */
    public GetAllArticleListsRequest withPortalID(@Nonnull String portalID) {
     ...
     * language is used.&lt;/li&gt;
     */
    public GetAllArticleListsRequest withLanguage(@Nullable LanguageQueryParameter language) {
        this.language = language;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAllArticleListsRequest other = (GetAllArticleListsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAllArticleListsRequest.class,
    ...
    public final static class Builder {
        ...
        public GetAllArticleListsRequest build() {
            return new GetAllArticleListsRequest(
                acceptLanguage, portalID, language);
        }
