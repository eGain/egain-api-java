...
public class GetbookmarkRequest {
     ...
     * representation and in error responses).
     */
    public GetbookmarkRequest withAcceptLanguage(@Nonnull AcceptLanguage acceptLanguage) {
     ...
     * by a dash and 4-15 digits.
     */
    public GetbookmarkRequest withPortalID(@Nonnull String portalID) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetbookmarkRequest other = (GetbookmarkRequest) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            acceptLanguage, portalID);
    }
    
    @Override
    public String toString() {
        return Utils.toString(GetbookmarkRequest.class,
