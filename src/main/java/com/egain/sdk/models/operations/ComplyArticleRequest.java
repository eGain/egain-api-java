...
public class ComplyArticleRequest {
    /**
     ...
     * representation and in error responses).
     */
    public ComplyArticleRequest withAcceptLanguage(@Nonnull AcceptLanguage acceptLanguage) {
     ...
     * by a dash and 4-15 digits.
     */
    public ComplyArticleRequest withPortalID(@Nonnull String portalID) {
     ...
     * and 4-15 digits.
     */
    public ComplyArticleRequest withArticleID(@Nonnull String articleID) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ComplyArticleRequest other = (ComplyArticleRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ComplyArticleRequest.class,
    ...
    public final static class Builder {
        ...
        public ComplyArticleRequest build() {
            return new ComplyArticleRequest(
                acceptLanguage, portalID, articleID);
        }
