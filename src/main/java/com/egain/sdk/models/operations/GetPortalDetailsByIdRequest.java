...
public class GetPortalDetailsByIdRequest {
    /**
    ...
    @JsonCreator
    public GetPortalDetailsByIdRequest(
     ...
     * representation and in error responses).
     */
    public GetPortalDetailsByIdRequest withAcceptLanguage(@Nonnull AcceptLanguage acceptLanguage) {
     ...
     * by a dash and 4-15 digits.
     */
    public GetPortalDetailsByIdRequest withPortalID(@Nonnull String portalID) {
     ...
     * language is used.&lt;/li&gt;
     */
    public GetPortalDetailsByIdRequest withLanguage(@Nullable LanguageQueryParameter language) {
        this.language = language;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPortalDetailsByIdRequest other = (GetPortalDetailsByIdRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPortalDetailsByIdRequest.class,
    ...
    public final static class Builder {
        ...
        public GetPortalDetailsByIdRequest build() {
            return new GetPortalDetailsByIdRequest(
                acceptLanguage, portalID, language);
        }
