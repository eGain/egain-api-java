 ...
 * AccessSource
 * 
 * <p>Provides information about the method in which the Article is accessed and is used for self-service
...
public enum AccessSource {
    ...
    public static Optional<AccessSource> fromValue(String value) {
        for (AccessSource o: AccessSource.values()) {
